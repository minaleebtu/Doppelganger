    ...
    # If the condition is met, it will process based on the argument/parameter
        ...
        for opt in option:
            ...
            if opt == '-h' or opt == '-help':
                ...
                print("\tpca -> PCA algorithm to reduce the number of features that were already extracted")
                print("\tdoppel -> doppelgänger detection algorithm to identify multiple identities of an author")
