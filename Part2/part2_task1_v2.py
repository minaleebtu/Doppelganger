...
info = data["content"].values.tolist()
...
def lemmatize (text):
    ...
    blob = TextBlob(str(cleantext(text)))

    return blob.words.lemmatize()


print ("Clean text : " ,cleantext(sample))
print("The words without stop words : ",  stop_words(sample))
print("Lemmatized words : ", lemmatize(sample))