...
#For task 2.a
def word_level:
    #counting the lowercase

    #counting the uppercase

    #counting the letters and digits per words

    #calculate the total words per comment and frequency the large words

#For task 2.b
def vocabulary_richness:
    #counting the number of syllables per word

    #counting the type-token ratio

    #counting the entropy of different vocab in a comment

#use this function for getting the shannon result
...
#use this function for getting the simpson result
...
#use this function for getting the sichel result
...
#For task 2.c
def sentence_level:
    #Count the number of short sentences
    ...
    #Count the average sentence length  per text
...
#For task 2f
def content_based:
    #measure the sensitivity and positivity per word and sentence
    #model = SentimentModel()

    #sentiment = model.predict_sentiment(sample)

#For task 2g
def idiosyncratic:
    #count the number of grammar mistakes within a sentence
...
#
    ...
    #count the uppercase word in a sentence

#For task 2h
def ease_reading:
    #calculate the ease reading level of each comments
    textstat.flesch_reading_ease()


def word_frequency:
    #calculate the word frequency
    #import the clean words
    ...
    #calculate the top 20 frequent words

# top_words = Counter(konter).most_common(20)
# print(top_words)


def noun_phrases:
    #extract the sentence into two or more meaningful words
    blb = TextBlobDE(sample)
    nounP = blb.noun_phrases
    print(nounP)
...
print("===============================================================================")
print("task2 e)")
print("- Frequency of used punctuation per sentence: ", puncCountPerSenList)
print("- Frequency of used punctuation per comment: ", puncCountPerCommList)
print("- Frequency of repeated occurrence of whitespace per sentence: ", multiSpacePerSenList)
print("- Frequency of repeated occurrence of whitespace per comment", multiSpacePerCommList)
