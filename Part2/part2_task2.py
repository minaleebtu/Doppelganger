...
# print("- Simpson's D measure: ", simpsonList)
# print("- Sichel's S measure: ", sichelList)
#
# print("===============================================================================")
...
print("===============================================================================")
print("task2 f) Content-based")
print("- Average positivity per word: ", totPosPerWord/wordCount)
print("- Average positivity per sentence: ", totPosPerSen/sentenceCount)
print("- Average sensitivity per word: ", totNegPerWord/wordCount)
print("- Average sensitivity per sentence: ", totNegPerSen/sentenceCount)
...
print("===============================================================================")
print("task2 h) Additional features")
print("- Noun Phrase: ", nounPhraseList)
print("- Named Entity Recognition: ", list(set(NERList)))
