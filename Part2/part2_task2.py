...
for row in contentList:
    ...
    for sentence in sentences:
        ...
        # print("total sentence length: ", sentenceLength)
...
print("- Frequency of large words: ", "XXXXXXXXX")
...
print("- Number of short sentences: ", "XXXXXXXXX")
print("- Number of long sentences: ", "XXXXXXXXX")
print("- Average sentence length(in characters) per text sample: ", sentenceLenPerCommList)
print("- Average sentence length per text sample: ", avg_sentence_per_comm)
